...
async def main(args):
    ...
    for r in r_values:
        ...
        for num in range(args.runs):
            ...
            # 在 main_QL.py 中，替换 strategy_evolution 绘图部分：
            ...
            plt.xticks(xticks, xtick_labels, fontsize=28)  # 字号从16调大到28
            plt.yticks(fra_yticks, fontsize=28)  # 字号从16调大到28

            # 增强可视化效果
            plt.grid(True, which='both', linestyle='--', alpha=0.5)
            plt.xlabel('t', fontsize=28, labelpad=10)  # 字号从16调大到28
            plt.ylabel('Fractions', fontsize=28, labelpad=10)  # 字号从16调大到28

            # 添加图例和注解
            plt.legend(loc='best', fontsize=28)  # 字号从16调大到28
...
if __name__ == "__main__":
    ...
    parser.add_argument('-is_fermi', action='store_true', default=False, help='is Fermi')
